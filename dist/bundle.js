...
const blank$ = rxjs_1.Observable.create((observer) => {
    observer.next(1); // émission de la valeur.
    observer.next(2);
    observer.next(3);
    observer.complete();
});
...
//l'inscrit et execute la function.
...
const nom$ = rxjs_1.Observable.fromEvent(inputs[0], 'keyup')
    .map((event) => event.target.value)
    .filter(value => value !== '');
const prenom$ = rxjs_1.Observable.fromEvent(inputs[1], 'keyup')
    .map((event) => event.target.value)
    .filter(value => value !== '');
const age$ = rxjs_1.Observable.fromEvent(inputs[2], 'keyup')
    .map((event) => event.target.value)
    .filter(value => value !== '');
const personne$ = rxjs_1.Observable.combineLatest(nom$, prenom$, age$)
    .map((values) => {
    return {
        nom: values[0],
        prenom: values[1],
...
//# sourceMappingURL=data:application/json;base64,
